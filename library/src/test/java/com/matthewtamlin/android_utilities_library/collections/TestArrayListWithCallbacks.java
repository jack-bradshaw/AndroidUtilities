...
public class TestArrayListWithCallbacks {
	...
	/**
	 * Test to ensure that {@link ArrayListWithCallbacks#add(Object)} functions correctly when null
	 * is passed. The test will only pass if the list is correctly modified, and the correct
	...
	/**
	 * Test to ensure that {@link ArrayListWithCallbacks#add(Object)} functions correctly when a
	 * non-null value is passed. The test will only pass if the list is correctly modified, and the
	...
	/**
	 * Test to ensure that {@link ArrayListWithCallbacks#add(int, Object)} throws an exception when
	 * a negative index is passed.
	 */
	...
	/**
	 * Test to ensure that {@link ArrayListWithCallbacks#add(int, Object)} throws an exception when
	 * a index which is too large is passed.
	 */
	@Test(expected = IndexOutOfBoundsException.class)
	...
	/**
	 * Test to ensure that {@link ArrayListWithCallbacks#add(int, Object)} functions correctly when
	 * a valid index and a null value are passed. The test will only pass if the list is correctly
	...
	/**
	 * Test to ensure that {@link ArrayListWithCallbacks#add(int, Object)} functions correctly when
	 * a valid index and a non-null value are passed. The test will only pass if the list is
	...
	/**
	 * Test to ensure that {@link ArrayListWithCallbacks#addAll(Collection)} throws an exception
	...
	/**
	 * Test to ensure that {@link ArrayListWithCallbacks#addAll(Collection)} functions correctly
	 * when a non-null value is passed. The test will only pass if the list is correctly modified,
	 * and the correct callbacks are delivered.
	 */
	@Test
	...
	/**
	 * Test to ensure that {@link ArrayListWithCallbacks#addAll(int, Collection)} throws an
	 * exception when a null Collection is passed.
	 */
	@Test(expected = NullPointerException.class)
	...
	/**
	 * Test to ensure that {@link ArrayListWithCallbacks#addAll(int, Collection)} throws an
	 * exception when a negative index is passed.
	 */
	@Test(expected = IndexOutOfBoundsException.class)
	...
	/**
	 * Test to ensure that {@link ArrayListWithCallbacks#addAll(int, Collection)} throws an
	 * exception when an index which is too large is passed.
	 */
	@Test(expected = IndexOutOfBoundsException.class)
	...
	/**
	 * Test to ensure that {@link ArrayListWithCallbacks#addAll(int, Collection)} functions
	 * correctly when a valid index and a non-null value are passed. The test will only pass if the
	 * list is correctly modified, and the correct callbacks are delivered.
	 */
	@Test
	...
	/**
	 * Test to ensure that {@link ArrayListWithCallbacks#remove(int)} throws an exception when a
	...
	/**
	 * Test to ensure that {@link ArrayListWithCallbacks#remove(int)} throws an exception when an
	 * index which is too large is passed.
	 */
	@Test(expected = IndexOutOfBoundsException.class)
	...
	/**
	 * Test to ensure that {@link ArrayListWithCallbacks#remove(Object)} functions correctly when a
	 * null value is passed. The test will only pass if the list is correctly modified, and the
	 * correct callbacks are delivered.
	 */
	@Test
	...
	/**
	 * Test to ensure that {@link ArrayListWithCallbacks#removeAll(Collection)} functions correctly
	 * when a non-null value is passed. The test will only pass if the list is correctly modified,
	 * and the correct callbacks are delivered.
	 */
	@Test
	...
	/**
	 * Test to ensure that {@link ArrayListWithCallbacks#set(int, Object)} throws an exception when
	 * a negative index is passed.
	 */
	@Test(expected = IndexOutOfBoundsException.class)
	...
	/**
	 * Test to ensure that {@link ArrayListWithCallbacks#set(int, Object)} throws an exception when
	 * an index which is too large is passed.
	 */
	@Test(expected = IndexOutOfBoundsException.class)
	...
	/**
	 * Test to ensure that {@link ArrayListWithCallbacks#set(int, Object)} functions correctly when
	 * a valid index and a null value is passed. The test will only pass if the list is correctly
	 * modified, and the correct callbacks are delivered.
	 */
	@Test
	...
	/**
	 * Test to ensure that {@link ArrayListWithCallbacks#set(int, Object)} functions correctly when
	 * a valid index and a non-null value is passed. The test will only pass if the list is
	 * correctly modified, and the correct callbacks are delivered.
	 */
	@Test
	...
	/**
	 * Test to ensure that {@link ArrayListWithCallbacks#clear()} (int, Object)} functions correctly
	 * when the list is empty. The test will only pass if the correct callbacks are delivered.
	 */
	@Test
	...
	/**
	 * Test to ensure that {@link ArrayListWithCallbacks#clear()} (int, Object)} functions correctly
	 * when the list is not empty. The test will only pass if the list is correctly modified, and
	 * the correct callbacks are delivered.
	 */
	@Test
	...
	/**
	 * Test to ensure that {@link ArrayListWithCallbacks#retainAll(Collection)} throws an exception
	 * when null is passed.
	 */
	@Test(expected = NullPointerException.class)
	@SuppressWarnings("ConstantConditions")
	...
	/**
	 * Test to ensure that {@link ArrayListWithCallbacks#retainAll(Collection)} functions correctly
	 * when the argument is not empty. The test will only pass if the list is correctly modified,
	 * and the correct callbacks are delivered.
	 */
	@Test
	...
	/**
	 * Test to ensure that {@link ArrayListWithCallbacks#retainAll(Collection)} functions correctly
	 * when the argument is empty. The test will only pass if the list is correctly modified, and
	 * the correct callbacks are delivered.
	 */
	@Test
